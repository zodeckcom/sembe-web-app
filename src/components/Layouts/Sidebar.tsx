...
const Sidebar = () => {
    ...
    const [accountType, setAccountType] = useState(localStorage.getItem('userAccountType'));
                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="nav-item">
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/wallet" className="group">
                                            <div className="flex items-center">
                                    ...
                                    {accountType === "SERVICE-PROVIDER" &&
                                        <>  <li className="menu nav-item">
                                            <button type="button" className={`${currentMenu === 'services' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('services')}>
                                                <div className="flex items-center">
                                                    <IconMenuInvoice className="group-hover:!text-primary shrink-0" />
                                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Manage Services')}</span>
                                                </div>
                                            ...
                                            <li className="nav-item">
                                                <NavLink to="/ratings" className="group">
                                                    <div className="flex items-center">
                                                        <IconStar className="group-hover:!text-primary shrink-0" />
                                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Rating')}</span>
                                                    </div>
                                                </NavLink>
                                            </li></>
                                    }
                                    <li className="nav-item">
                                        <NavLink to="/blank" className="group">
                                            <div className="flex items-center">
