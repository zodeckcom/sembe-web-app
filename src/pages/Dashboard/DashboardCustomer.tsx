    ...
    return (
        <div>
            <div className='mb-3 md:flex w-full gap-4 bg-white dark:bg-slate-900 shadow-md rounded-lg p-4'>
                ...
                <div className="max-w-xl bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <div className="md:flex">
                        <div className="md:w-40 md:h-auto md:flex-shrink-0">
                            <img className="w-full h-auto md:w-40 md:h-full object-cover" src="/assets/images/mine/laundry1.png" alt="Image" />
                        </div>
                        <div className="p-8 dark:text-white bg-green-700 dark:bg-green-900">
                            <div className="uppercase tracking-wide text-sm text-white font-semibold">Excellent Laundry Services</div>
                            <a href="#" className="block mt-1 text-sm font-medium text-slate-200 dark:text-white hover:underline">Schedule your order</a>
                ...
                <div className="max-w-xl mt-3 md:mt-0  bg-blue-800 dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                    <div className="md:flex">
                        ...
                        <div className="p-8 dark:text-white">
                            <div className="uppercase tracking-wide text-sm text-white font-semibold">Wallets</div>
                            <a href="#" className="block mt-1 text-md leading-tight font-medium text-slate-200 dark:text-white hover:underline">Wallet Balance: <span className='font-bold text-lg'>$24,740</span></a>
                            <button type="button" className="mt-2 btn btn-primary">
                                Add Funds
                            </button>
                        </div>
